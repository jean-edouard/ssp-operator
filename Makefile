...
bundle: operator-sdk manifests csv-generator
	...
	./csv-generator --csv-version $(VERSION) --namespace kubevirt --operator-image $(IMG) --file bundle/manifests/ssp-operator.clusterserviceversion.yaml --webhook-port 9443 --webhook-remove-certs > bundle/manifests/ssp-operator.clusterserviceversion.yaml.new
